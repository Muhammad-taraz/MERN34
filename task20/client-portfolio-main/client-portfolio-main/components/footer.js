...
export default function Footer() {
  const socialMediaLinks = [
    {
      name: "Linkedin",
      href: "https://www.linkedin.com/in/haseebullahabbasi/",
      icon: "Linkedin",
      hoverClass: "hover:text-blue-600",
    },
    {
      name: "Twitter",
      href: "https://twitter.com/haseebullahabbasi",
      icon: "Twitter",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/haseeb.abbasi.562/",
      icon: "Instagram",
      hoverClass: "hover:text-orange-600",
    },
  ];

  const navigation = ["Mission", "Services"];
        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5 sm:p-4 ">
          <div className="lg:col-span-2">
            <div>
              ...
              >
                <Image src="/img/logo.png" alt="N" width="200" height="200" />
              </Link>
            </div>
